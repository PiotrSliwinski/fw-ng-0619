...
// Add up the sequence
sequence.reduce((accumulator,value) => accumulator+value );
...
// Turn an array of people into markup.

const people = ["Bert", "Jane", "Fred", "Mary"];

const draw = (list,person) => `${list}<p>${person}</p>`;

people.reduce( draw,"" );

document.body.innerHTML += people.reduce( draw,"" )
